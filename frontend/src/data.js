...
export const step2Groups = {
  A: {
    questions: [
      { q: "Q5. 선호하는 액세서리 스타일은?", a: [{ text: "고급 시계", res: "올드머니" }, { text: "패턴 양말", res: "프레피룩" }, { text: "액세서리 안 함", res: "미니멀" }, { text: "가죽 벨트", res: "오피스룩" }] },
      { q: "Q6. 가장 즐겨 입는 상의 종류는?", a: [{ text: "최고급 니트", res: "올드머니" }, { text: "금장 블레이저", res: "프레피룩" }, { text: "무지 셔츠", res: "미니멀" }, { text: "정갈한 수트 셔츠", res: "오피스룩" }] },
      { q: "Q7. 본인이 지향하는 멋의 방향은?", a: [{ text: "여유로운 럭셔리", res: "올드머니" }, { text: "위트 있는 단정함", res: "프레피룩" }, { text: "본질적인 심플함", res: "미니멀" }, { text: "프로의 신뢰감", res: "오피스룩" }] },
      { q: "Q8. 주말 시간을 보내는 장소는?", a: [{ text: "호텔 다이닝", res: "올드머니" }, { text: "테니스 코트", res: "프레피룩" }, { text: "조용한 카페", res: "미니멀" }, { text: "자기계발 공간", res: "오피스룩" }] }
    ]
  },
  B: {
    questions: [
      { q: "Q5. 가장 자주 신는 신발 종류는?", a: [{ text: "가죽 워커", res: "워크웨어" }, { text: "빈티지 단화", res: "아메카지" }, { text: "트레킹화", res: "고프코어" }, { text: "군용 스타일 신발", res: "밀리터리룩" }] },
      { q: "Q6. 옷을 볼 때 집착하는 디테일은?", a: [{ text: "튼튼한 봉제 마감", res: "워크웨어" }, { text: "자연스러운 워싱감", res: "아메카지" }, { text: "확실한 방수 기능", res: "고프코어" }, { text: "절도 있는 실루엣", res: "밀리터리룩" }] },
      { q: "Q7. 좋아하는 원단이나 소재 느낌은?", a: [{ text: "묵직한 캔버스", res: "워크웨어" }, { text: "오래된 데님", res: "아메카지" }, { text: "기능성 나일론", res: "고프코어" }, { text: "단단한 코튼", res: "밀리터리룩" }] },
      { q: "Q8. 로망이 있는 취미 생활은?", a: [{ text: "가구 DIY", res: "워크웨어" }, { text: "캠핑 혹은 낚시", res: "아메카지" }, { text: "고강도 백패킹", res: "고프코어" }, { text: "사격이나 서바이벌", res: "밀리터리룩" }] }
    ]
  },
  C: {
    questions: [
